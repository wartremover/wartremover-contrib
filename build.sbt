...
val wartremoverVersion = "3.1.2"

val scala212Versions = Seq("2.12.13", "2.12.14", "2.12.15", "2.12.16", "2.12.17")
val scala213Versions = Seq("2.13.6", "2.13.7", "2.13.8", "2.13.9", "2.13.10")
val scala3Versions = Seq("3.1.1", "3.1.2", "3.1.3", "3.2.0", "3.2.1", "3.2.2", "3.3.0-RC6")
    ...
    libraryDependencies ++= {
      if (scalaBinaryVersion.value == "3") {
        Seq(
          ...
          "io.get-coursier" % "coursier" % "2.1.4" % Test cross CrossVersion.for3Use2_13 exclude ("io.argonaut", "*") exclude ("org.scala-lang.modules", "scala-xml_2.13"),
