...
val scala213Versions = Seq("2.13.6", "2.13.7", "2.13.8", "2.13.9", "2.13.10", "2.13.11", "2.13.12")
val scala3Versions = Seq("3.1.1", "3.1.2", "3.1.3", "3.2.0", "3.2.1", "3.2.2", "3.3.0", "3.3.1", "3.3.2-RC1", "3.4.0-RC1")
    ...
    libraryDependencies ++= {
      if (scalaBinaryVersion.value == "3") {
        Seq(
          ...
          "io.get-coursier" % "coursier" % "2.1.8" % Test cross CrossVersion.for3Use2_13 exclude ("io.argonaut", "*") exclude ("org.scala-lang.modules", "scala-xml_2.13"),
