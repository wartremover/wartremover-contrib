...
val scala3Versions = Seq("3.1.1", "3.1.2", "3.1.3", "3.2.0", "3.2.1", "3.2.2", "3.3.0-RC4")
    ...
    libraryDependencies ++= {
      if (scalaBinaryVersion.value == "3") {
        Seq(
          ...
          "io.get-coursier" % "coursier" % "2.1.2" % Test cross CrossVersion.for3Use2_13 exclude ("io.argonaut", "*") exclude ("org.scala-lang.modules", "scala-xml_2.13"),
